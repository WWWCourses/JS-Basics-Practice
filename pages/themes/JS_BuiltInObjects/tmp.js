...
var RAT = {
    ...
    edgeC: function(){
      ...
      /* Ако желаем резултата да бъде закръглен до втората цифра след десетичната запетая, а не знаем как => търсим си нужния метод, например в https://www.w3schools.com, чрез израза: "javascript round to decimal places method"
      и четем ... :-*/
